...
| `innerResponses` | `Array<ServiceResponse>` | yes      | an array of inner `ServiceRespons`es produced by inner services |
...
|`toJson(spacer)`| serializes current instance to json |
